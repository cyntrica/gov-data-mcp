 ...
 *
 *   import { getAgenciesByState, getSummarizedCrime, getArrestData } from "us-gov-open-data/sdk/fbi";
 *
...
export const SUMMARIZED_OFFENSES: Record<string, string> = {
  V: "Violent Crime",
  P: "Property Crime",
  HOM: "Homicide",
  RPE: "Rape",
...
export const ARREST_OFFENSES: Record<string, string> = {
...
export const SUPPLEMENTAL_OFFENSES: Record<string, string> = {
...
export const HATE_CRIME_BIAS_CODES: Record<string, string> = {
...
export const NIBRS_OFFENSES: Record<string, string> = {
  // Homicide
